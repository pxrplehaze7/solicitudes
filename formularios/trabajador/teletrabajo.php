                ...
                <div class="container-solicitud">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="situacion" class="form-select" id="situacion" class="form-select">
                                <option value="" hidden> Selecciona</option>
                                <?php
                                mysqli_select_db($conn, 'solicitudes');
                                $situacion = "SELECT IDSit, sit_tipo_situacion FROM tl_situacion";
                                $r_situacion = mysqli_query($conn, $situacion);
                    ...
                    <div class="documentos">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="text_s_elegido" name="text_s_elegido" rows="3">ola</textarea>
                            </div>
                        </div>
                    </div>
